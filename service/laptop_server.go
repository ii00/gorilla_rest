...
// RateLaptop is a bidirectional-streaming RPC that allows clien to rate a stream of
// laptops with a score, and returns a stream of average score for each of them.
