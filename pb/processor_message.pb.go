...
var file_proto_processor_message_proto_rawDesc = []byte{
	...
	0x0e, 0x67, 0x72, 0x70, 0x63, 0x5f, 0x61, 0x70, 0x70, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x1a,
	...
	0x65, 0x6d, 0x6f, 0x72, 0x79, 0x52, 0x06, 0x6d, 0x65, 0x6d, 0x6f, 0x72, 0x79, 0x42, 0x07, 0x5a,
...
var file_proto_processor_message_proto_goTypes = []interface{}{
	(*CPU)(nil),    // 0: grpc_app.proto.CPU
	(*GPU)(nil),    // 1: grpc_app.proto.GPU
	(*Memory)(nil), // 2: grpc_app.proto.Memory
}
var file_proto_processor_message_proto_depIdxs = []int32{
	2, // 0: grpc_app.proto.GPU.memory:type_name -> grpc_app.proto.Memory
